...
- 成果
  - 不動産事業の企画業務における新規事業支援
    - 不動産事業の企画業務における新規事業の立ち上げ支援
    - 市場調査・競合分析・事業計画策定のAIサポートにより企画立案の効率化を実現
...
- 成果
  - 営業支援エージェントの構築
    - 名刺登録からHubSpot連携したSlackに常駐する営業支援エージェントを開発
    - 名刺情報の自動取り込み・CRM登録と、Slack上でのフォローアップ提案を自動化
  - スカウト文自動生成Chrome拡張機能
